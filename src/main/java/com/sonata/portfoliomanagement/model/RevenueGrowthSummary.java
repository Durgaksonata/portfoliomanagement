...
public class RevenueGrowthSummary {
    ...
    public RevenueGrowthSummary(int id, String vertical, String classification,String deliveryDirector, String deliveryManager, String account, String projectManager, String projectName, int financialYear, String quarter, LocalDate month, float accountExpected, float forecast, float gap) {
        this.id = id;
