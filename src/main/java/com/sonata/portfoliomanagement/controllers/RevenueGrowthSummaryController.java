...
public class RevenueGrowthSummaryController {
    ...
    public RevenueGrowthSummaryController() {
    ...
    public ResponseEntity<Set<String>> getDMByVerticalAndClassification(@RequestBody RevenueDTO dmList) {
        ...
        List<RevenueGrowthSummary> revenues = revenuegrowthRepo.findDmByVerticalInAndClassificationIn(verticals, classifications);
        for (RevenueGrowthSummary revenue : revenues) {
            deliveryManagerNames.add(revenue.getDeliveryManager());
        }
        return ResponseEntity.ok(deliveryManagerNames);
    ...
    public List<RevenueGrowthSummary> getLatestGrowthFinancialYearData() {
        // Retrieve all data
        List<RevenueGrowthSummary> allData = revenuegrowthRepo.findAll();
