...
public class RevenueGrowthSummaryController {
    ...
    private List<RevenueGrowthSummary> verticalList;
    private List<RevenueGrowthSummary> accountList;
    private List<RevenueGrowthSummary> pmlist;
    private List<RevenueGrowthSummary> classificationlist;
    private List<RevenueGrowthSummary>projectlist;
    private List<RevenueGrowthSummary>FYlist;
    private List<RevenueGrowthSummary>quarterlist;

    private List<RevenueGrowthSummary>dmlist;
...
//    }
    ...
    public void setverticalList(List<RevenueGrowthSummary> verticalList) {
    ...
    public  Set<String> getUniqueVerticals() {
        return (verticalList == null) ? new HashSet<>() :
                verticalList.stream()
                        .map(RevenueGrowthSummary::getVertical)
                        .collect(Collectors.toSet());
    }
    public void setaccountList(List<RevenueGrowthSummary> accountList) {
    ...
    public void setpmlist(List<RevenueGrowthSummary> pmlist) {
        this.pmlist = pmlist;
    ...
    public  Set<String> getUniquePms() {
        return (pmlist == null) ? new HashSet<>() :
                pmlist.stream()
                        .map(RevenueGrowthSummary::getProjectManager)
                        .collect(Collectors.toSet());
    }
    public void setclassificationlist(List<RevenueGrowthSummary> classificationlist) {
    ...
    public  Set<String> getUniqueclassification() {
        return (classificationlist == null) ? new HashSet<>() :
                classificationlist.stream()
                        .map(RevenueGrowthSummary::getClassification)
                        .collect(Collectors.toSet());
    }
    public void setprojectlist(List<RevenueGrowthSummary> projectlist) {
    ...
    public  Set<String> getUniqueproject() {
        return (projectlist == null) ? new HashSet<>() :
                projectlist.stream()
                        .map(RevenueGrowthSummary::getProjectName)
                        .collect(Collectors.toSet());
    }
    public void setFYlist(List<RevenueGrowthSummary> FYlist) {
        this.FYlist = FYlist;
    ...
    public void setquarterlist(List<RevenueGrowthSummary> quarterlist) {
    ...
    public  Set<String> getUniqueQuarter() {
        return (quarterlist == null) ? new HashSet<>() :
                quarterlist.stream()
                        .map(RevenueGrowthSummary::getQuarter)
                        .collect(Collectors.toSet());
    }
    public void setdmlist(List<RevenueGrowthSummary> dmlist) {
        this.dmlist = dmlist;
