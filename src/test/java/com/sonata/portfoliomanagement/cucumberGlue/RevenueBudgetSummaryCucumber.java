...
public class RevenueBudgetSummaryCucumber {
    ...
    static class RevenueBudgetSummaryRepositoryMock implements RevenueBudgetSummaryRepository {
        ...
        @Override
        public List<RevenueBudgetSummary> findByMonthIn(List<LocalDate> months) {
            return null;
        }
