...
class RevenueGrowthTests {
    ...
    public void getRevenueTest() {
        // Create a mock RevenueGrowthSummary object
        RevenueGrowthSummary mockRevenue = new RevenueGrowthSummary(1, "Vertical1", "Classification1", "DD1", "DM1", "Account1", "PM1", "Project1", 2024, "Q1", "April", 1000, 900, 100);

        // Mock the repository behavior
        when(revenuerepo.findById(1)).thenReturn(Optional.of(mockRevenue));

        // Call the repository method
        RevenueGrowthSummary rn = revenuerepo.findById(1).get();

        // Verify the result
        assertEquals(1, rn.getId());
    }
//
//
//    @Test
...
//    }
        ...
        public void testGetDataByVerticalAndClassification() {
            ...
            // Mock data for revenue growth summaries
            List<RevenueGrowthSummary> mockDataList = Arrays.asList(
                    new RevenueGrowthSummary(1, "Vertical1", "Classification1", "DD1", "DM1", "Account1", "PM1", "Project1", 2024, "Q1", "April", 1000, 900, 100),
                    new RevenueGrowthSummary(2, "Vertical1", "Classification2", "DD2", "DM2", "Account2", "PM2", "Project2", 2024, "Q1", "April", 1500, 1300, 200),
                    new RevenueGrowthSummary(3, "Vertical2", "Classification1", "DD3", "DM3", "Account3", "PM3", "Project3", 2024, "Q1", "April", 1200, 1100, 100)
            );
            ...
            for (RevenueGrowthSummary dataItem : mockDataList) {
